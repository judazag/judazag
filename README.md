...
### Ingeniero de Sistemas | Data Scientist | AI & Backend Engineer

Soy un apasionado por construir soluciones donde la **Inteligencia Artificial** se encuentra con arquitecturas de **Software Empresarial**. Mi enfoque combina el rigor científico del análisis de datos con la robustez de los sistemas distribuidos y microservicios.
...
#### Persistencia de Datos (Políglota)
